...
const BMETcard = () => {
    ...
    return (
        <div className='mx-auto lg:w-1/3 lg:mt-14 px-5'>
            <div className="border border-[#1a7a86] rounded-xl">
                ...
                <div className=" flex  justify-center gap-10 px-5 py-10 border-black">
                    <div className="w-1/3 border rounded-lg">
                        
                        <img src={singleManPowerData?.img} className='  lg:w-32 lg:h-32 h-32 mx-auto rounded-lg' />
                    </div>
